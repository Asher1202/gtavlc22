...
new iBitchLabel[BITCHES][128] = {
	"DJ SONA: {FFFFFF}Anh Anh Anh Oi.. Sa rang hea yo!\nNhan F De Len Giuong\n{00FF00}$1.000.000",
	"Ngoc Trinh: {FFFFFF}Co tien thi choi khong co thi bien, OK?\nNhan F De Len Giuong\n{00FF00}$100.000",
	"Ngan 98: {FFFFFF}Em khong muon lam Bitch dau ma.. Di voi em nha >.<!\nNhan F De Len Giuong\n{00FF00}$250.000",
	"Sakura: {FFFFFF}Onii-Chan, Di Voi Em Di Di...\nNhan F De Len Giuong\n{00FF00}$1.000.000"
};
...
public Excitement(playerid,bitchid)
{
	...
	else if(Player[playerid][excMod]==2)
	{
	    ...
	    if((bitchid==0) || (bitchid==3)) TextDrawSetString(gagnfuck,"Nhan Lien Tuc Chuot Phai Va Trai De Choi.");
	    else TextDrawSetString(gagnfuck,"Nhan Lien Tuc Chuot Phai Va Trai De Choi..");
	...
	else if(Player[playerid][excMod]==4)
	{
	    ...
	    if(Player[playerid][pExcitement] < 86.0) //sex/bj NOT complete
	    {
			...
			if(bitchid==0)
			{
				...
				else if(rand==9)//kap�d��ar�, oturarak sikerken
				{
...
hook OnGameModeInit() {
	...
	exctext = TextDrawCreate(397.000000,104.000000,"DO THOA MAN:");
	...
	gagnfuck = TextDrawCreate(12.000000,110.000000,"Nhan Lien Tuc Chuot Phai Va Trai De Choi");
	...
	objectbitch[0] = CreateDynamicObject(974, 2200.5, -1187, 1031.6, 0, 0, 272);
	objectbitch[1] = CreateDynamicObject(2987, 2232.2, -1167, 1030, 0, 0, 112.498);
	objectbitch[2] = CreateDynamicObject(323, 2235.1001, -1171.9, 1029.4, 0, 94, 299.75);
	objectbitch[3] = CreateDynamicObject(1828, 2220.3999, -1150.6, 1024.8, 0, 0, 170);
	objectbitch[4] = CreateDynamicObject(2819, 2240.5, -1150.9, 1028.8, 0, 0, 0);
	objectbitch[5] = CreateDynamicObject(2846, 2241.7, -1170.3, 1028.8, 0, 0, 0);
	objectbitch[6] = CreateDynamicObject(2845, 2233.7, -1167.2, 1028.8, 0, 0, 0);
	objectbitch[7] = CreateDynamicObject(2987, 2239.3, -1159.8, 1030, 0, 0, 95.248);
	objectbitch[8] = CreateDynamicObject(2773, 2201.5, -1189.3, 1029.3, 0, 0, 34);
	objectbitch[9] = CreateDynamicObject(2773, 2201.8999, -1188.1, 1029.3, 0, 0, 351.997);
	objectbitch[10] = CreateDynamicObject(971, 2214.8999, -1141.2, 1025, 90, 354.053, 95.947);
	objectbitch[11] = CreateDynamicObject(2079, 2217.3, -1144.5, 1025.8, 0, 0, 90);
	objectbitch[12] = CreateDynamicObject(2079, 2215.3999, -1144.9, 1025.8, 0, 0, 192);
	objectbitch[13] = CreateDynamicObject(985, 2235.8999, -1156.6, 1028.7, 270, 180, 90);
	objectbitch[14] = CreateDynamicObject(976, 2237.5, -1152.2, 1028.7, 270, 180, 180);
	objectbitch[15] = CreateDynamicObject(985, 2253.7, -1160.2, 1028.7, 270, 180, 300.002);
	objectbitch[16] = CreateDynamicObject(985, 2233.5, -1167.9, 1028.6, 270, 359.995, 0);
	objectbitch[17] = CreateDynamicObject(976, 2238, -1192.6, 1032.7, 90, 5.446, 84.554);
	objectbitch[18] = CreateDynamicObject(976, 2240.5, -1193.4004, 1028.7, 90, 6.01, 4.977);
	objectbitch[19] = CreateDynamicObject(976, 2251.7, -1186.2, 1028.7, 90, 5.488, 173.241);
	objectbitch[20] = CreateDynamicObject(976, 2238.3999, -1192.9, 1028.6, 90, 5.274, 40.704);
	objectbitch[21] = CreateDynamicObject(985, 2228.5, -1180.5, 1028.6, 270, 180, 90);
	objectbitch[22] = CreateDynamicObject(985, 2221.7, -1182.8, 1028.6, 270, 359.996, 270.002);
	objectbitch[23] = CreateDynamicObject(985, 2221.8999, -1176.3, 1028.6, 270, 180, 90.005);
	objectbitch[24] = CreateDynamicObject(976, 2209.6001, -1195.4, 1028.6, 90, 5.371, 174.623);
	objectbitch[25] = CreateDynamicObject(985, 2248.3999, -1163, 1028.7, 270, 359.996, 120);
			...
			for(new i=0;i<BITCHES;i++)
			{
				if(IsPlayerInRangeOfPoint(playerid,3.0,iBitchPos[i][0],iBitchPos[i][1],iBitchPos[i][2]) && (Bitch[i][bBusy]==-1) && (!Player[playerid][pFuckedBitch][i]))
				{
				    if(GetPlayerCash(playerid) >= iBitchCost[i])
				    {
						...
						GivePlayerCash(playerid,- iBitchCost[i]);
